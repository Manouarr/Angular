...
function lancerBouteilleV1(callbackSucces) {
...
//Fin
console.log("Début");
lancerBouteilleV2().then(() => console.log("Yes j'ai reçu une réponse"), //correspondra au "resolve" l62
